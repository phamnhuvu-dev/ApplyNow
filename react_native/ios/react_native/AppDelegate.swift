...
//  react_native
//
//  Created by Phạm Như Vũ on 8/22/18.
...
//        let jsCodeLocation =
        ...
        let rootView = RCTRootView(bundleURL: jsCodeLocation, moduleName: "react_native", initialProperties: nil, launchOptions: launchOptions)
